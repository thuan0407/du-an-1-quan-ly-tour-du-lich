...
<body>
    <div class="content-wrapper ">
        ...
        <div class="row">
            <div class="col btn btn-success">Đặt tour lẻ</div>
            <div class="col btn btn-danger">Tour chờ duyệt</div>
            <div class="col btn btn-primary">Tour đang hoạt động</div>
            <div class="col btn btn-warning">Tour đã kết thúc</div>
    ...
    <table class="table">
        ...
        <?php foreach($list_tour as $tt): ?>
            <tr>
                ...
                <td>
                    <a href="#" class="btn btn-warning">Xem chi tiết tour</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
